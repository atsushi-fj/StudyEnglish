  ...
  export default {
    ...
    methods: {
      async fetchUserData() {
        ...
        try {
            const response = await axios.get(`http://127.0.0.1:5000/${userId}/account`);
      ...
      async update() {
        ...
        try {
          ...
          const response = await axios.put(`http://127.0.0.1:5000/${userId}/account`, putData);
      ...
      async deleteUser() {
        try {
            const userId = this.$route.params.user_id;
            const response = await axios.delete(`http://127.0.0.1:5000/${userId}/account`);
